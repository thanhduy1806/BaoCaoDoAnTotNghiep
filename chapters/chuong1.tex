...
Luận văn tập trung thiết kế và kiểm chứng mô đun cấu hình thí nghiệm đa năng cho vệ tinh nhỏ. Trọng tâm của đề tài là xây dựng concept payload theo hướng mô đun, trong đó các board chức năng được phân vai rõ ràng để phục vụ điều khiển, giao tiếp, thu nhận dữ liệu và mở rộng ngoại vi. Các nhiệm vụ chính của luận văn bao gồm:
...
\begin{itemize}
    ...
    \item \textbf{Thiết kế phần cứng:} Thiết kế các khối nguồn, xử lý, lưu trữ, giao tiếp và đầu nối ngoại vi phục vụ quá trình tích hợp mô đun cấu hình thí nghiệm.
    ...
    \item \textbf{Kiểm chứng hệ thống:} Đưa các kịch bản thí nghiệm điều khiển nhiệt độ để kiểm tra tính ổn định và đáp ứng của hệ thống ở nhiệm vụ điều khiển nhiệt độ thí nghiệm. Tiến hành các bài thí nghiệm điều khiển các vị trí laser và cường độ laser để đánh giá sự chính xác của giá trị cường độ ánh sáng ngõ ra mong muốn so với ngõ vào. Đánh giá kết quả nguồn năng lượng thu về từ photo diode.
\end{itemize}

Kết quả cần đạt của luận văn là một thiết kế mô đun cấu hình thí nghiệm có cấu trúc rõ ràng, có khả năng giao tiếp và phối hợp giữa các board chức năng, đồng thời được kiểm chứng ở mức hệ thống thông qua cấu hình đo quang học và điều khiển nhiệt độ. Giới hạn của đề tài là không đi sâu đánh giá đặc tính sinh hóa của mẫu vật, mà tập trung vào nền tảng phần cứng, firmware điều khiển và luồng dữ liệu phục vụ thí nghiệm.
