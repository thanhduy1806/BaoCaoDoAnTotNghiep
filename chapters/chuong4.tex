...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{picture/firmware/Bootloader/Luu_do_tong_quat.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/firmware/Bootloader/block-xTP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/firmware/Bootloader/block-wait.png}
