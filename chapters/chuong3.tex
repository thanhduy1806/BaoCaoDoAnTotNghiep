...
\subsection{Ràng buộc kiến trúc kết nối phần cứng}
...
Từ ràng buộc đó, phần cứng không thể triển khai theo hướng gom toàn bộ chức năng lên một board duy nhất, mà bắt buộc phải phân tách thành các board chức năng độc lập gồm EXP, IF, LASER và PHOTO. Cách phân tách này vừa bảo đảm khả năng bố trí theo kích thước payload, vừa tạo thuận lợi cho tổ chức đường tín hiệu, phân bố linh kiện và tích hợp cơ--điện của toàn hệ thống.
...
\textbf{Phương pháp 1: Điều khiển tập trung toàn bộ LASER/PHOTO trên một khối xử lý}
\begin{itemize}
    \item Ưu điểm: logic tập trung tại một điểm, dễ quản lý ở mức tổng thể.
    \item Khuyết điểm: tăng tải xử lý cho khối điều khiển trung tâm, giảm tính thời gian thực ở khối thí nghiệm, khó mở rộng khi tăng số tác vụ cục bộ.
\end{itemize}

\textbf{Phương pháp 2: Điều khiển phân cấp trong nội bộ EXP, MPU xử lý cấp cao và MCU điều phối cục bộ}
\begin{itemize}
    \item Ưu điểm: phân tách rõ lớp xử lý cấp cao và lớp điều khiển thời gian thực; EXP xử lý nhanh các tác vụ thời gian thực (điều khiển LASER/PHOTO, đọc nhiệt, điều khiển TEC/HEATER); tăng tính mô đun và khả năng tái sử dụng.
    \item Khuyết điểm: cần định nghĩa rõ cơ chế phối hợp lệnh-trạng thái giữa MPU và MCU trong nội bộ EXP để tránh xung đột điều khiển.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Khối PHOTO $6 \times 6$:} là ma trận phần tử thu quang, tiếp nhận tín hiệu ánh sáng từ hệ quang và tạo tín hiệu dòng tương ứng cường độ thu được.

    \item \textbf{Khối SWITCHING $6 \times 6$:} thực hiện chọn kênh thu trong ma trận PHOTO, định tuyến tín hiệu từ phần tử thu được chọn sang chuỗi xử lý tương tự.
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí cảm biến BMP390 onboard}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí connector BMP390}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí cảm biến gia tốc}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí connector HD4}
...
\begin{figure}[H]
    ...
    \caption{Mạch buck từ 12\,V sang 5\,V}
...
\begin{figure}[H]
    ...
    \caption{LDO 3.3\,V cho các IC trên board}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lý khối temp}
    \label{fig:if-temp}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Nguồn 3.3\,V cho IO0/1 của FPGA}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{picture/laser/ref.jpg}
...
\begin{figure}[H]
    ...
    \caption{Mạch nguồn BUCK 12\,V - 5\,V}
...
\begin{figure}[H]
    ...
    \caption{Mạch nguồn LDO 5\,V - 3.3\,V}
    \label{fig:laser-ldo}
\end{figure}
