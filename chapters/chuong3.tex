...
\begin{itemize}
    ...
    \item \textbf{Khối DDR3L và 2 eMMC:} cung cấp bộ nhớ làm việc tốc độ cao và bộ nhớ lưu trữ không mất dữ liệu cho tác vụ xử lý và vận hành của IF.
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí khối chuyển mạch I2C của board PHOTO}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí khối mở rộng I/O điều khiển camera}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí khối dao động và logic điều phối xung clock}
    \label{fig:photo-osc}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí khối LDO cấp nguồn cho board PHOTO}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí khối tạo điện áp tham chiếu của board PHOTO}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí khối chuyển mạch chọn photodiode}
    \label{fig:photo-sw}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí khối khuếch đại chuyển dòng sang áp và lọc khử chồng phổ}
...
Giá trị này nhỏ hơn rất nhiều so với $f_{Nyquist} = 250\,\mathrm{kHz}$ của ADC, do đó về mặt chống chồng lấn phổ thì thiết kế này là an toàn và hợp lí. Tuy nhiên, điều đó cũng cho thấy băng thông tín hiệu hữu ích bị giới hạn chỉ quanh mức vài kHz.
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí khối ADC của board PHOTO}
    \label{fig:photo-adc}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ nguyên lí khối tạo nguồn âm của board PHOTO}
