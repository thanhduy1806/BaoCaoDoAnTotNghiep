...
\begin{figure}[H]
    ...
    \caption{Schematic khối điều khiển solenoid thứ nhất}
...
\begin{figure}[H]
    ...
    \caption{Schematic khối điều khiển solenoid thứ 2}
...
\begin{figure}[H]
    ...
    \caption{Schematic khối connector-exp}
...
eMMC thường đóng vai trò bộ nhớ không mất dữ liệu chính của hệ MPU, dùng để lưu bootloader, kernel/device tree, root filesystem và dữ liệu ứng dụng. Theo mô hình SD/MMC phổ biến, eMMC có các vùng boot partition riêng, vùng user area và có thể có thêm RPMB cho dữ liệu bảo mật, nên phù hợp làm bộ nhớ hệ thống ổn định trong vận hành lâu dài.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/if/mram.png}
    \caption{Khối MRAM}
    \label{fig:if-mram}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Khối USB switch input}
    \label{fig:if-usb-sw-in}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/if/if-usb-sw-out.png}
    \caption{Khối USB switch output}
    \label{fig:if-usb-sw-out}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/if/uart-mux.png}
    \caption{Khối UART MUX}
    \label{fig:if-uart-mux}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/if/spi-sw-lvds-tx.png}
    \caption{Khối SPI switch LVDS TX}
    \label{fig:if-spi-sw-lvds-tx}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/if/spi-sw-lvds-rx.png}
    \caption{Khối SPI switch LVDS RX}
    \label{fig:if-spi-sw-lvds-rx}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/if/spi-lvds-tx.png}
    \caption{Khối SPI LVDS TX}
    \label{fig:if-spi-lvds-tx}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/if/spi-lvds-rx.png}
    \caption{Khối SPI LVDS RX}
    \label{fig:if-spi-lvds-rx}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{picture/if/3v3-vccio01.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{picture/if/50mhz-fpga.png}

    \includegraphics[width=0.7\textwidth]{picture/if/24mhz-fpga.png}
    \caption{Khối tạo dao động cho FPGA}
...
\begin{figure}[H]
    ...
    \caption{Tín hiệu trên chân FPGA}
    \label{fig:tin-hieu-fpga}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Schematic khối spi-sw}
    \label{fig:if-spi-sw}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{picture/if/temp.png}
    \caption{Schematic khối temp}
    \label{fig:if-temp}
\end{figure}
