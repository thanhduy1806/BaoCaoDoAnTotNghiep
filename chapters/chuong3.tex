...
OPA4340 là op-amp CMOS 4 kênh rail-to-rail, được dùng trong mạch này để thực hiện ba chức năng: khuếch đại chuyển dòng-quang thành điện áp (TIA), đệm tín hiệu và tạo bộ lọc anti-alias trước ADC. Op-amp hoạt động theo nguyên lý khuếch đại sai biệt điện áp giữa hai đầu vào \texttt{+/-}; với mạng hồi tiếp điện trở-tụ, tầng đầu chuyển dòng photodiode thành điện áp, các tầng sau tạo đáp ứng lọc và đệm tải cho \texttt{ADC\_IN}. Ngõ vào/ra hoàn toàn là tín hiệu analog, không có giao tiếp số. Ưu điểm của OPA4340 là làm việc nguồn đơn 2.7 V đến 5.5 V, rail-to-rail input/output, dòng bias rất nhỏ và công suất thấp, nên thích hợp cho front-end quang điện hơn nhiều op-amp đa kênh cũ vốn cần nguồn đối xứng hoặc có biên độ common-mode hẹp.
