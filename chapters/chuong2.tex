...
\begin{figure}[H]
    ...
    \caption{Mô-đun TEC (Thermoelectric Cooler)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{picture/components/HEATER.jpg}
    \caption{Phần tử gia nhiệt HEATER}
...
\begin{figure}[H]
    ...
    \caption{Cơ cấu điện từ SOLENOID}
