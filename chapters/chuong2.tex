...
\begin{itemize}
    ...
    \item Để theo dõi nhiệt độ trong buồng thí nghiệm, sử dụng linh kiện NTC.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{picture/components/laser-diode.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{picture/components/photo-diode.png}
