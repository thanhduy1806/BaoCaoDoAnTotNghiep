...
\section{Cấu trúc hệ thống thí nghiệm}
\label{sec:kien_truc_exp_if_photo_laser}

\subsection{Mục tiêu của hệ thống thí nghiệm}
...
\begin{itemize}
    ...
    \item \textbf{Khối giao tiếp mở rộng:} hỗ trợ kết nối hệ thống thí nghiệm với các giao diện bên ngoài hoặc các mô đun mở rộng khác. Khối này giúp hệ thống không bị giới hạn trong một cấu hình cố định, đồng thời tạo điều kiện để truyền lệnh, truyền dữ liệu và tích hợp thêm ngoại vi khi cần.
    ...
    \item \textbf{Khối giám sát môi trường:} theo dõi các thông số trạng thái của buồng thí nghiệm, đặc biệt là nhiệt độ và các đại lượng liên quan đến điều kiện vận hành. Dữ liệu giám sát được sử dụng làm phản hồi cho khối điều khiển nhiệt, đồng thời giúp người dùng đánh giá trạng thái hệ thống trong suốt quá trình đo.
\end{itemize}
