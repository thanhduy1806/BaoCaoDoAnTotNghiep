...
Đồ án tập trung nghiên cứu và thiết kế mô đun cấu hình thí nghiệm đa năng cho vệ tinh nhỏ. Mục tiêu chính của đề tài là xây dựng một kiến trúc phần cứng và phần mềm có khả năng điều khiển thí nghiệm, giao tiếp với các board chức năng, thu nhận dữ liệu và hỗ trợ mở rộng cho nhiều cấu hình thí nghiệm khác nhau.
